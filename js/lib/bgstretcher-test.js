...
;(function($){
	...
	$.fn.bgStretcher = function(settings){
		...
		function _genHtml(body_content){
			...
			body_content.each(function(){
				...
				cur_bgstretcher.children('.bgstretcher-page').css({'position': 'relative', 'z-index': 10});
			});
	...
	/*  Pagination  */
	$.fn.bgStretcher.pagination = function(){//alert('test');
		var l = $(allLIs).length;
		var output = ''; var i = 0;
		if (l > 0) {
			output += '<ul id="foo2">';
				for (i = 0; i < l; i++){
					output += '<li><a href="javascript:;"><img src="'+$(allLIs).eq(i).find("img").attr('src')+'" width="153" height="115"/></a></li>';
				}
			output += '</ul>';
